...
@Operation(summary = "新增")
    public ApiResponse<Boolean> create(@RequestBody @Validated InventoryLedgerPO po) {
        return ApiResponse.ok(service.create(po));
    }

@PostMapping("/update")
@Operation(summary = "修改")
    public ApiResponse<Boolean> update(@RequestBody @Validated InventoryLedgerPO po) {
