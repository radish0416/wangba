...
import com.cybercafe.repository.mapper.PackageRedeemMapper;
...
public class PackageRedeemServiceImpl implements PackageRedeemService {
    ...
    @Override
    public IPage<PackageRedeemPO> listPage(PackageRedeemQueryDTO dto) {
        Page<?> page = new Page<>(dto.current == null ? 1 : dto.current, dto.size == null ? 10 : dto.size);
        return mapper.selectByDynamic(page, dto);
    }

    @Override
    public java.util.List<PackageRedeemPO> listAll(PackageRedeemQueryDTO dto) {
